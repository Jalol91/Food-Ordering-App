									...
									<div className='col-md-6'>
										<div className='single-item-wrap'>
											...
											<div className='wrap-details'>
												<h5>
													<a href='single-product.html'>
														BBQ Chicken Classic Pizza Large
													</a>
												</h5>
												<div className='wrap-footer'>
													<div className='rating'>
										...
										<ul>
											...
											<li>
												<a href='#'>
													...
													French fries <span>(14)</span>
												</a>
											</li>
											<li>
												<a href='#'>
													<img src='assets/img/category/5.png' alt='img' /> Fast
													food <span>(10)</span>
												</a>
											</li>
											<li>
												<a href='#'>
													<img src='assets/img/category/6.png' alt='img' /> Soft
													drinks <span>(28)</span>
												</a>
											</li>
										</ul>
