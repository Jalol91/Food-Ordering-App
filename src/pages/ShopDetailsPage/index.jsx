							...
							<div className='col-md-6'>
								<div className='shop-item-details'>
									...
									<ul className='cat'>
										<li> SKU: PZ2866</li>
										<li>
											Categories: <a href='#'>Pizza</a>
										</li>
										<li>
											Tags: <a href='#'>Boscaiola,</a>
											<a href='#'>Pizza</a>
										</li>
									</ul>
										...
										<div className='tab-content' id='pills-tabContent'>
											<div
												...
												<p className='mb-4'>
													...
													ingredients, baked quickly—usually, in a commercial
													setting, using a wood-fired oven heated to a very high
													temperature—and served hot{' '}
												</p>
												<div className='row'>
													<div className='col-6'>
														<img
															className='w-100'
															src='assets/img/blog/single-2.png'
															alt='img'
														/>
													</div>
													<div className='col-6'>
														<img
															className='w-100'
															src='assets/img/blog/single-3.png'
															alt='img'
														/>
													</div>
												</div>
												<p className='mt-4'>
													...
													that it was named for Queen Margherita, wife of
													Umberto I, who was said to have liked its mild fresh
													flavour and to have also noted that its topping
													colours—green, white, and red—were those of the
													Italian flag.
												</p>
											</div>
											<div
												...
												<div className='comment-area'>
													<div className='media'>
														<div className='media-left'>
															<img
																src='assets/img/blog/comment.png'
																alt='img'
															/>
														</div>
