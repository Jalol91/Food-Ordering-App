											...
											<li>
												<div className='form-check'>
													...
													<label
														...
														htmlFor='flexRadioDefault1'></label>
												</div>
												<div className='details'>
													<h6>
														Credit Cart{' '}
														<img
															src='assets/img/icon/peyment-card.png'
															alt='img'
														/>
													</h6>
													<p>
														Pay with visa, Anex, MasterCard, Maestro,Discover
														and many other credit and debit credit vai paypal
													</p>
												</div>
											</li>
											<li>
												<div className='form-check'>
													...
													<label
														className='form-check-label'
														htmlFor='flexRadioDefault2'></label>
												</div>
												<div className='details'>
													<h6>
														PayPal{' '}
														<img
															src='assets/img/icon/paypal-card.png'
															alt='img'
														/>
													</h6>
